...
$CC -std=c++17 -I"$INCLUDEDIR" ${CFLAGS} -c abi_compatibility.cpp chrono_utils.cpp file.cpp liblog_symbols.cpp logging.cpp mapped_file.cpp parsebool.cpp parsenetaddress.cpp process.cpp properties.cpp stringprintf.cpp strings.cpp threads.cpp test_utils.cpp ${src}
...
cd "$LIBDIR/libcrypto_utils"
$CC -Iinclude -I"$LIBDIR/boringssl/include" ${CFLAGS} -c android_pubkey.c
...
$AR rcs "$LIBOUTDIR/libcrypto.a" *.o
rm -r *.o
...
$AR rcs "$LIBOUTDIR/libprotobuf-cpp-full.a" *.o
rm -r *.o
...
${CPP} -std=c++17 -I"$INCLUDEDIR" ${CFLAGS} -D_FILE_OFFSET_BITS=64 -o "$BINDIR/lpmake" lpmake.cc "$LIBOUTDIR/liblp.a" "$LIBOUTDIR/libsparse.a" "$LIBOUTDIR/libext4_utils.a" "$LIBOUTDIR/libz.a" "$LIBOUTDIR/libbase.a" "$LIBOUTDIR/fmtlib.a" "$LIBOUTDIR/liblog.a" "$LIBOUTDIR/libcrypto_utils.a" "$LIBOUTDIR/libcrypto.a" -lpthread ${LDFLAGS}

${CPP} -std=c++17 -I"$INCLUDEDIR" ${CFLAGS} -D_FILE_OFFSET_BITS=64 -o "$BINDIR/lpadd" lpadd.cc "$LIBOUTDIR/liblp.a" "$LIBOUTDIR/libsparse.a" "$LIBOUTDIR/libext4_utils.a" "$LIBOUTDIR/libz.a" "$LIBOUTDIR/libbase.a" "$LIBOUTDIR/fmtlib.a" "$LIBOUTDIR/liblog.a" "$LIBOUTDIR/libcrypto_utils.a" "$LIBOUTDIR/libcrypto.a" -lpthread ${LDFLAGS}

${CPP} -std=c++17 -I"$INCLUDEDIR" ${CFLAGS} -D_FILE_OFFSET_BITS=64 -o "$BINDIR/lpflash" lpflash.cc "$LIBOUTDIR/liblp.a" "$LIBOUTDIR/libsparse.a" "$LIBOUTDIR/libext4_utils.a" "$LIBOUTDIR/libz.a" "$LIBOUTDIR/libbase.a" "$LIBOUTDIR/fmtlib.a" "$LIBOUTDIR/liblog.a" "$LIBOUTDIR/libcrypto_utils.a" "$LIBOUTDIR/libcrypto.a" -lpthread ${LDFLAGS}

${CPP} -std=c++17 -I"$INCLUDEDIR" ${CFLAGS} -D_FILE_OFFSET_BITS=64 -o "$BINDIR/lpunpack" lpunpack.cc "$LIBOUTDIR/liblp.a" "$LIBOUTDIR/libsparse.a" "$LIBOUTDIR/libext4_utils.a" "$LIBOUTDIR/libz.a" "$LIBOUTDIR/libbase.a" "$LIBOUTDIR/fmtlib.a" "$LIBOUTDIR/liblog.a" "$LIBOUTDIR/libcrypto_utils.a" "$LIBOUTDIR/libcrypto.a" -lpthread ${LDFLAGS}

${CPP} -std=c++17 -I"$INCLUDEDIR" ${CFLAGS} -D_FILE_OFFSET_BITS=64 -o "$BINDIR/lpdump" lpdump.cc dynamic_partitions_device_info.pb.cc lpdump_host.cc "$LIBOUTDIR/liblp.a" "$LIBOUTDIR/libsparse.a" "$LIBOUTDIR/libext4_utils.a" "$LIBOUTDIR/libz.a" "$LIBOUTDIR/libbase.a" "$LIBOUTDIR/fmtlib.a" "$LIBOUTDIR/liblog.a" "$LIBOUTDIR/libcrypto_utils.a" "$LIBOUTDIR/libcrypto.a" "$LIBOUTDIR/libjsonpbparse.a" "$LIBOUTDIR/libprotobuf-cpp-full.a" -lpthread ${LDFLAGS}
